...
<div class="content-wrapper">
              ...
              <table id="registerTable" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <?php
                          $tanggal_masuk = $register->tanggal_masuk;
                          $deadline = 30 - $tanggal_masuk->diffInDays($now);
                      ?>
                      
                      <td>{{ ($deadline > 0) ? $deadline. ' hari lagi' : 'Waktu habis' }}</td>
    ...
    @if(Auth::check())
      <div class="container">
          <div class="pull-left"> 
              <a href="register/create" class="btn btn-block btn-primary btn-flat"><i class="fa fa-plus-square"></i> Tambah Register</a>
          </div>
      </div>
    @endif
</div>
